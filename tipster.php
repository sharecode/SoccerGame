...
<head> 
	...
	<meta name="keywords" content="ทายผลบอล,เซียนบอล">
	<meta name="robots" content="ALL">
	<title>ทำเนียบเซียนบอล</title>
...
<h2>ทำเนียบเซียนบอล เรียงตามลำดับคะแนน</h2>
...
$get_tipster=$_con->query("select id,aliasname,round(score,2) as score,score as score2 from member_ order by score desc limit 50;");
