...
<div class="hide"><table><tbody id="team_buffer"></tbody></table></div>
	...
	<table border="0" style="width:100%;">
		<tr>
			<td valign="top"><h2>(บอลเดี่ยว) ตารางทายผลบอล <?php echo $show_day;?></h2></td>
			<td align="right"><a href="mixparlay.php"><span class="reg_link_but" style="color:black;font-size:20px;">บอลชุด</span></a></td>
		</tr>
	</table>
	...
	<table border="0" style="font-size:12px; width:100%;" cellpadding="0" cellspacing="0" class="market_tb" id="market_tb">
			<thead>
			<tr>
				<td rowspan="2" align="center" style="border-top: solid 1px #b1b1b1;"><span class="cursor" onclick="load_match(0)">เวลา&#9207;</span></td>
